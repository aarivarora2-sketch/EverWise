...
export default function PhoneShell({ children }) {
  return (
    <div className="app-viewport box-border h-[100dvh] min-h-[100dvh] w-full overflow-hidden sm:flex sm:items-center sm:justify-center sm:py-8">
      <div className="app-shell relative mx-auto flex h-full min-h-0 w-full max-w-[430px] flex-col overflow-hidden shadow-none sm:h-[min(860px,100%)] sm:rounded-[40px] sm:shadow-[0_20px_60px_rgba(34,32,28,0.18)]">
        {children}
      </div>
    </div>
  );
